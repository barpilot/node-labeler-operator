...
type PodKiller struct {
	pt     *labelerv1alpha1.PodTerminator
...
func NewPodKiller(pt *labelerv1alpha1.PodTerminator, k8sCli kubernetes.Interface, logger log.Logger) *PodKiller {
	return &PodKiller{
		pt:     pt,
		k8sCli: k8sCli,
		logger: logger,
...
func NewCustomPodKiller(pt *labelerv1alpha1.PodTerminator, k8sCli kubernetes.Interface, time TimeWrapper, logger log.Logger) *PodKiller {
	return &PodKiller{
		pt:     pt,
		k8sCli: k8sCli,
		logger: logger,
...
func (p *PodKiller) SameSpec(pt *labelerv1alpha1.PodTerminator) bool {
